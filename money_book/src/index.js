    ...
    return(
      <div className="entry">
        <fieldset>
          ...
          <div>項目: <input type="text" value={this.state.item} onChange={(event) => this.onChangeItem(event)}/></div>
          <div>金額: <input type="text" value={this.state.amount} onChange={(event) => this.onChangeAmount(event)}/></div>
