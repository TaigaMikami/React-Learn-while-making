...
class WeatherPage extends Component {
  constructor(props) {
    ...
    this.Places =[
      {name: '札幌', id:2128295}, {name: '札幌', id:2128295},
      {name: '札幌', id:2128295}, {name: '札幌', id:2128295}
    ]
    this.OpenWeatherMapKey = "c3168c4e09f6a9493912804c8158dac5"
  }
      ...
      <MuiThemeProvider>
        <Card style={{margin: 30}}>
          ...
          <CardText style={{position: 'relative'}}>
            <RefreshIndicator status={this.state.loading ? 'loading' : 'hide'} top={40} left={100} loadingColor="#00f" />
